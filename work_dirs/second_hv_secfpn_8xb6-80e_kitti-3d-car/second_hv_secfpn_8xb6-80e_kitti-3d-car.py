...
db_sampler = dict(
    data_root='/home/javier/datasets/kitti/',
    info_path='/home/javier/datasets/kitti/kitti_dbinfos_train.pkl',
    rate=1.0,
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        data_root='/home/javier/datasets/kitti/',
                        info_path=
                        '/home/javier/datasets/kitti/kitti_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
...
val_evaluator = dict(
    type='KittiMetric',
    ann_file='/home/javier/datasets/kitti/kitti_infos_val.pkl',
    metric='bbox',
    backend_args=None)
test_evaluator = dict(
    type='KittiMetric',
...
resume = False
launcher = 'none'
work_dir = './work_dirs/second_hv_secfpn_8xb6-80e_kitti-3d-car'

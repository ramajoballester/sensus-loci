...
data_root = 'data/TUMTraf-custom_kittiformat/'
class_names = ['Pedestrian', 'Cyclist', 'Car']
point_cloud_range = [0, -60.16, -5, 140.80, 60.16, 5]
...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'tumtraf_infos_train.pkl',
    rate=1.0,
    prepare=dict(
...
val_evaluator = dict(
    type='KittiMetric',
    ann_file=data_root + 'tumtraf_infos_val.pkl',
    metric='bbox',
    backend_args=backend_args,
)
